...
class Shipping_Method_Sedex extends WC_Shipping_Method
{
    /**
    ...
    {
        $this->id = 'mf_shipping_method_sedex';
        $this->instance_id = absint($instance_id);
        $this->enabled = "yes";
        $this->method_title = __('Sedex');
        $this->method_description = __('Frete via Sedex');
        $this->supports = array(
            'shipping-zones',
            'instance-settings',
        );
    ...
    public function calculate_shipping($package = array())
    {
        ...
        $rate = array(
            ...
            'cost' => $sedex['valor'],
            'meta_data' => array(
                '_delivery_estimate' => ((int) $sedex['prazoEntrega'] + (int) $this->get_option('additional_days')),
            )
        );
